...
namespace C23.StockManage
{
    public partial class frmReturnT : Form
    {
        ...
        private void tsbtnSave_Click(object sender, EventArgs e)
        {
            ...
            SqlDataReader sqlread = boperate.getread("select VerifyID from tb_Verify where VerifyID='" + dt.Rows[dgvReturnInfo.CurrentCell.RowIndex][5].ToString() + "' ");
            sqlread.Read();
            if (sqlread.HasRows)
            {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                string varStockID = dt.Rows[i][5].ToString();
                                                string varSCheckCount = dt.Rows[i][6].ToString();
                                                decimal varReCount = Decimal.Parse(dt.Rows[i][7].ToString());
                                                ...
                                                string varStorageType = dt.Rows[i][16].ToString();
                                                string varLocationName = dt.Rows[i][17].ToString();
                                            ...
                                            "','" + varNT + "','" + var1 + "','" + var2 + "','" + var3 + "','" + varStockID +
                                            ...
                                            "','" + varReDate + "','" + varPur + "','" + varMaker + "','" + varDate + "','" + varTime + "')";
                                                ...
                                                + "ReCount,PUnitPrice,TaxRate,TotalCount,Tax,NoTax,TNTotalCount,TNTax,TNNoTax,StockID,StorageType,"
                                                ...
                                                if (sqlreadPay.HasRows)
                                                {
                                                    ...
                                                    boperate.getcom("update tb_AcPay set TNTotalCount='" + varupdateTotalCount + "',TNNoTax='" + varupdateNoTax + "', TNTax='" + varupdateTax +
                                                         "',ReTNTotalCount='" + var1 + "',ReTNTax='" + var2 + "',ReTNNoTax='" + var3 + "' where StokerID='" + varStokerID + "'");
        ...
        private void dgvReturnInfo_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvReturnInfo.CurrentCell.ColumnIndex == 5)
            {
            ...
            if (dgvReturnInfo.CurrentCell.ColumnIndex == 16)
            {
        ...
        private void setStockData()
        {
            ...
            dgvReturnInfo[5, dgvReturnInfo.CurrentCell.RowIndex].Value = getStockInfo[4];
            dgvReturnInfo[6, dgvReturnInfo.CurrentCell.RowIndex].Value = getStockInfo[5];
            dgvReturnInfo[8, dgvReturnInfo.CurrentCell.RowIndex].Value = getStockInfo[6];
            dgvReturnInfo[9, dgvReturnInfo.CurrentCell.RowIndex].Value = getStockInfo[7];
            dgvReturnInfo[16, dgvReturnInfo.CurrentCell.RowIndex].Value = getStockInfo[8];
            dgvReturnInfo[17, dgvReturnInfo.CurrentCell.RowIndex].Value = getStockInfo[9];
        ...
        {
            dgvReturnInfo.Rows[dgvReturnInfo.CurrentCell.RowIndex].Cells[16].Value = inputTextDataStorage[0];

        }
        private void setLocationData()
        {
            dgvReturnInfo.Rows[dgvReturnInfo.CurrentCell.RowIndex].Cells[17].Value = inputTextDataLocation[0];
        }
